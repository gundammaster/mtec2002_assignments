...
person = {"first name":"alexis","last name":"shuffler","fave food":"bacon strips","eye color":"brown","teeth":"26"}
# print out the dictionary
print person
# print out your favorite_food
print person["fave food"]
...
print "%s has %s teeth" % (person["first name"], person["teeth"])
# change your favorite food
person["fave food"] = "pizza"
